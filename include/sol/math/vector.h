 ...
 *     Description         :
 **********************************************************************************/
#ifndef SOL_MATH_VECTOR_H__
#define SOL_MATH_VECTOR_H__
...
class Vector : public Matrix<DType> {
 ...
 public:
  ...
  inline expr::BinaryMapExp<expr::op::left,
                            (expr::ExprType::kDense | expr::ExprType::kSparse),
                            Matrix<DType>, expr::ExprType::kDense, EType,
                            expr::ExprType::kSparse, DType>
  slice(const expr::Exp<EType, DType, expr::ExprType::kSparse>& indexes) {
