...
template <typename OP, typename EType1, typename EType2, typename DType,
          int exptype1, int exptype2,  typename =  std::enable_if<exptype1 != ExprType::kSparse || exptype2 != ExprType::kSparse>::type>
inline 
BinaryMapExp<OP, (exptype1 | exptype2), EType1, exptype1, EType2, exptype2, DType>
...
#define ArithmeticBinaryMapExpTpl(opx, opr)                                 \
  template <typename EType1, typename EType2, typename DType, int exptype1, \
            int exptype2>                                                   \
  inline BinaryMapExp<op::opr, (exptype1 | exptype2),  EType1, exptype1, EType2, exptype2, DType> \
  ...
  inline BinaryMapExp<op::opr, (ExprType::kValue | exptype), ScalarExp<int>, ExprType::kValue, EType, exptype, int> \
    ...
    return MakeExp<op::opr>(lhs, rhs);                                      \
                                                                            ...
                                                                            \
  template <typename EType, int exptype>                                    \
  inline BinaryMapExp<op::opr, (exptype | ExprType::kValue), EType, exptype, ScalarExp<int>, ExprType::kValue, int> \
    ...
    return MakeExp<op::opr>(lhs, rhs);                                      \
                                                                            ...
                                                                            \
   template <typename EType, int exptype>                                    \
  inline BinaryMapExp<op::opr, (ExprType::kValue | exptype), ScalarExp<float>, ExprType::kValue, EType, exptype, float> \
    ...
    return MakeExp<op::opr>(lhs, rhs);                                      \
                                                                            ...
                                                                            \
  template <typename EType, int exptype>                                    \
  inline BinaryMapExp<op::opr, (exptype | ExprType::kValue), EType, exptype, ScalarExp<float>, ExprType::kValue, float> \
    ...
    return MakeExp<op::opr>(lhs, rhs);                                      \
                                                                            ...
                                                                            \
   template <typename EType, int exptype>                                    \
  inline BinaryMapExp<op::opr, (ExprType::kValue | exptype), ScalarExp<double>, ExprType::kValue, EType, exptype, double> \
    ...
    return MakeExp<op::opr>(lhs, rhs);                                      \
                                                                            ...
                                                                            \
  template <typename EType, int exptype>                                    \
  inline BinaryMapExp<op::opr, (exptype | ExprType::kValue), EType, exptype, ScalarExp<double>, ExprType::kValue, double> \
...
template <typename EType1, typename EType2, typename DType, int exptype1,
          int exptype2>
inline BinaryMapExp<op::trunc, (exptype1 | exptype2), EType1, exptype1, EType2, exptype2, DType> truncate(const Exp<EType1, DType, exptype1> &lhs,
                     const Exp<EType2, DType, exptype2> &rhs) {
  return MakeExp<op::trunc>(lhs, rhs);
}

template <typename EType, int exptype>
inline BinaryMapExp<op::trunc, (exptype | ExprType::kValue), EType, exptype, ScalarExp<float>, ExprType::kValue, float> truncate(const Exp<EType, float, exptype> &lhs,
                     const ScalarExp<float> &rhs) {
  return MakeExp<op::trunc>(lhs, rhs);
}

template <typename EType, int exptype>
inline BinaryMapExp<op::trunc, (ExprType::kValue | exptype), ScalarExp<float>, ExprType::kValue, EType, exptype, float> truncate(const ScalarExp<float> &lhs,
                     const Exp<EType, float, exptype> &rhs) {
  return MakeExp<op::trunc>(lhs, rhs);
}

template <typename EType, int exptype>
inline BinaryMapExp<op::trunc, (exptype | ExprType::kValue), EType, exptype, ScalarExp<double>, ExprType::kValue, double>
truncate(const Exp<EType, double, exptype> &lhs,
	const ScalarExp<double> &rhs) {
	return MakeExp<op::trunc>(lhs, rhs);
}

template <typename EType, int exptype>
inline BinaryMapExp<op::trunc, (ExprType::kValue | exptype), ScalarExp<double>, ExprType::kValue, EType, exptype, double>
truncate(const ScalarExp<double> &lhs,
	const Exp<EType, double, exptype> &rhs) {
	return MakeExp<op::trunc>(lhs, rhs);
}
...
inline BinaryMapExp<op::left, (ExprType::kDense | ExprType::kSparse), EType1, ExprType::kDense, EType2, ExprType::kSparse, DType>
